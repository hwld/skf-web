  ...
  return (
    <main className="rounded-lg bg-base-800 border gap-10 border-base-700 grid grid-cols-[1fr_auto] p-6">
      <div className="flex flex-col gap-4">
        ...
        <button className="border border-primary-600 bg-primary-700/15 rounded-lg p-4 w-full gap-2 flex flex-col items-center hover:bg-primary-700/25 transition duration-100">
      ...
      <div className="bg-base-950 rounded-lg border border-base-700 p-10 gap-6 hidden xl:flex flex-col 2xl:w-[700px]">
        <div className="grid place-items-center gap-6 sticky top-[100px] mt-[200px]">
          <img src="./logo.svg" className="h-10 2xl:h-16" />
  ...
  return (
    <div className="h-[140px] bg-base-700 rounded-lg flex flex-col justify-between p-4">
      ...
      <div className="flex justify-between items-end">
        <button className="size-12 rounded-full bg-primary-400 flex items-center justify-center hover:bg-primary-300 transition duration-100">
...
function ProblemSetCardButton({ iconClass }: ProblemSetCardButtonProps) {
  return (
    <button className="size-7 group hover:bg-base-500 rounded-sm grid place-items-center transition duration-100">
      <span
        className={clsx(
          iconClass,
